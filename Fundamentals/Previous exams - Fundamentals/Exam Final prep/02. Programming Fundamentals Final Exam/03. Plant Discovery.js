...
// въртене през стойностите:
   for (let key of Object.keys(plantColection)) { //минаваме през всички ключове в обекта (['Arnoldii', 'Woodii', 'Welwitschia']):
        ...
        for (let i = 1; i < plantColection[key].length; i++) { // минаваме през всеки елемент в стойността към все ключ, като започваме от 1 (i = 1), защото на 0ва позиция се намира rarety- тo, което има само 1 число за стойност и не ни интересува
                                                               // [4]
                                                               // [5, 10, 5]
                                                               // [2, 7]
