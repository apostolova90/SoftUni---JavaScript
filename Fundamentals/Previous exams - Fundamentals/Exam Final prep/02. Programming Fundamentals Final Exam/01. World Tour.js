...
for(let i = 0; i < array.length; i++) {
    ...
    if (command === "Add Stop"){
        ...
        if (index >= 0 && index < allStops.length){
            let first = allStops.substring(0, index);
            let second = allStops.substring(index, allStops.length);
            allStops = first + string + second;
        }
    ...
    if (command === "Remove Stop"){
        ...
        if (startIndex >= 0 && startIndex < allStops.length){
            if (endIndex >= 0 && endIndex < allStops.length){
                let first = allStops.substring(0, startIndex);
                let second = allStops.substring(endIndex + 1, allStops.length);
