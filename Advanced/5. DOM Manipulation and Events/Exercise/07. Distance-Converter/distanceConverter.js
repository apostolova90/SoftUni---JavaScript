function attachEventsListeners() {
    ...
    // взимаме двете полете (from & to)
    let [inputField, outputField] = document.querySelectorAll('input[type="text"]');
    
    // взимаме units - падащите менюта     (от какво, на какво трябва да се превърне)
    ...
    // закачаме му eventListener да следи дали бутона е натиснат и какво да се случи, ако е
